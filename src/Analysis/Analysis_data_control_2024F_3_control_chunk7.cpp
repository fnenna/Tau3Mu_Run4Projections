...
int main(int narg, char** arg){
   ...
   if(strcmp(type, "data") == 0){
    ...
    if (strcmp(type, "data_control") == 0){
        ...
        cout << "Data " << datasetName << endl << endl;
        TChain* chain = new TChain("Tree3Mu/ntuple");
        chain->AddFile("/lustre/cms/store/user/fnenna/ParkingDoubleMuonLowMass3/SkimDsPhiPi_2024eraF_stream3_Mini_v3/240917_161930/0001/Tree_PhiPi_1016.root");
        chain->AddFile("/lustre/cms/store/user/fnenna/ParkingDoubleMuonLowMass3/SkimDsPhiPi_2024eraF_stream3_Mini_v3/240917_161930/0001/Tree_PhiPi_1325.root");
        chain->AddFile("/lustre/cms/store/user/fnenna/ParkingDoubleMuonLowMass3/SkimDsPhiPi_2024eraF_stream3_Mini_v3/240917_161930/0001/Tree_PhiPi_1139.root");
        chain->AddFile("/lustre/cms/store/user/fnenna/ParkingDoubleMuonLowMass3/SkimDsPhiPi_2024eraF_stream3_Mini_v3/240917_161930/0001/Tree_PhiPi_1075.root");
        chain->AddFile("/lustre/cms/store/user/fnenna/ParkingDoubleMuonLowMass3/SkimDsPhiPi_2024eraF_stream3_Mini_v3/240917_161930/0001/Tree_PhiPi_1235.root");
        chain->AddFile("/lustre/cms/store/user/fnenna/ParkingDoubleMuonLowMass3/SkimDsPhiPi_2024eraF_stream3_Mini_v3/240917_161930/0001/Tree_PhiPi_1050.root");
        chain->AddFile("/lustre/cms/store/user/fnenna/ParkingDoubleMuonLowMass3/SkimDsPhiPi_2024eraF_stream3_Mini_v3/240917_161930/0001/Tree_PhiPi_1274.root");
        chain->AddFile("/lustre/cms/store/user/fnenna/ParkingDoubleMuonLowMass3/SkimDsPhiPi_2024eraF_stream3_Mini_v3/240917_161930/0001/Tree_PhiPi_1179.root");
        chain->AddFile("/lustre/cms/store/user/fnenna/ParkingDoubleMuonLowMass3/SkimDsPhiPi_2024eraF_stream3_Mini_v3/240917_161930/0001/Tree_PhiPi_1127.root");
        fileout = "AnalysedTree_data_control_2024F_3_control7.root";
        myAnalizer_control class_data(chain, fileout);
        class_data.Loop_DsPhiPi(type, datasetName); 
    }
