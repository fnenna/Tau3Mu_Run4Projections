...
config.General.requestName = 'SkimDsPhiPi_2024eraC_stream1_Mini_v3'
...
config.Data.inputDataset = '/ParkingDoubleMuonLowMass1/Run2024C-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'SkimDsPhiPi_2024eraC_stream1_Mini_v3'
