...
config.General.requestName = 'SkimDsPhiPi_2024eraC_stream4_Mini_v3'
...
config.Data.inputDataset = '/ParkingDoubleMuonLowMass4/Run2024C-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'SkimDsPhiPi_2024eraC_stream4_Mini_v3'
