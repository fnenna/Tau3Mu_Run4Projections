...
config.General.requestName = 'SkimDsPhiPi_2024eraC_stream0_Mini_v3'
...
config.Data.inputDataset = '/ParkingDoubleMuonLowMass0/Run2024C-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'SkimDsPhiPi_2024eraC_stream0_Mini_v3'
