...
config.General.requestName = 'SkimDsPhiPi_2024eraC_stream3_Mini_v3'
...
config.Data.inputDataset = '/ParkingDoubleMuonLowMass3/Run2024C-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'SkimDsPhiPi_2024eraC_stream3_Mini_v3'
