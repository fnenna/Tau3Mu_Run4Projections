...
config.General.requestName = 'SkimDsPhiPi_2024eraC_stream2_Mini_v3'
...
config.Data.inputDataset = '/ParkingDoubleMuonLowMass2/Run2024C-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'SkimDsPhiPi_2024eraC_stream2_Mini_v3'
