...
config.General.requestName = 'SkimDsPhiPi_2024eraC_stream5_Mini_v3'
...
config.Data.inputDataset = '/ParkingDoubleMuonLowMass5/Run2024C-PromptReco-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'SkimDsPhiPi_2024eraC_stream5_Mini_v3'
